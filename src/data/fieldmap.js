const fieldMap = {
  "h0-m1-b0": {
    text: "Is your company based in the United States?",
    type: "radio"
  },
  "h0-m1-b1": {
    text: "Is your company in any of the following sectors?",
    type: "radio"
  },
  ...
  "h0-m2-b4": {
    text:
      "How much of your own money have you invested (or will invest) in this business?",
    type: undefined
  },
  "h0-m2-b5": {
    text: "How much have others invested in this business?",
    type: undefined
  },
  ...
  "h0-m3-b2": {
    text: "Are you expecting to be profitable this year?",
    type: "radio"
  },
  "h0-m3-b3": {
    text: "If you are not profitable, when do you expect to be?",
    type: undefined
  },
  "h0-m3-b4": {
    text:
  ...
  "h1-m3-sm1-b3": {
    text: "Do you want to highlight your raise location on your Raise Page?",
    type: "radio"
  },
  ...
  "h1-m3-sm1-b10": {
    text: "Is your raise location different than your headquarter location?",
    type: "radio"
  }, //type=decisionWrapper"
  ...
  "h2-m2-sm0-b4": {
    text: "Please upload your most recent bank statement",
    type: undefined
  }, //type=fileInput
  ...
  "h2-m2-sm1-b0": {
    text: "Does your company have a third-party accountant?",
    type: "radio"
  }, //type=decisionWrapper"
  ...
  "h2-m4-sm1-b0": {
    text:
      "Within the past three years, have you participated in any other exempt offerings? (Reg CF, Reg A+, Reg D, etc.)?",
    type: "radio"
  }, //type=decisionWrapper"
  "h2-m4-sm1-b1": { text: "h2-m4-sm1-b1", type: undefined },
  "h2-m4-sm2-b0": {
    text: "Does your company have any capital resources?",
    type: "radio"
  }, //type=decisionWrapper"
  ...
  "h3-m1-b5": {
    text:
      "Does your company have outside legal counsel assisting with this raise?",
    type: "radio"
  }, //type=decisionWrapper"
  ...
  "h4-m2-sm1-b6": {
    text:
      "Explain the methods for company valuation which led to the price of your securities.",
    type: undefined
  },
  "h4-m2-sm1-b5": {
    text:
  ...
  "h4-m2-sm1-b4": {
    text:
      "Are there any limitations to shareholders voting rights? Please explain below",
    type: undefined
  },
  "h4-m2-sm1-b3": {
    text: "Do shareholders have equity voting rights?",
    type: "radio"
  },
